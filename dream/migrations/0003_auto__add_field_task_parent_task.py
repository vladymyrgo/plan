...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'dream_task', 'parent_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_tasks', null=True, to=orm['dream.Task']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.parent_task'
        db.delete_column(u'dream_task', 'parent_task_id')
    ...
    models = {
        ...
        u'dream.idea': {
            'Meta': {'ordering': "('-updated',)", 'object_name': 'Idea'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'dream.task': {
            ...
            'is_purchase': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
