...
dream_patterns = patterns('',
    # noqa
    url(r'^dreams/$', DreamListView.as_view(), name='list'),
...
plan_patterns = patterns('',
    ...
    url(r'^dreams/(?P<dream_slug>[-_\w]+)/plans/new/$',
        ...
        name='new'),
    url(r'^dreams/(?P<dream_slug>[-_\w]+)/plans/(?P<pk>\d+)/edit/$',
...
task_patterns = patterns('',
    # noqa
    url(r'^dreams/(?P<dream_slug>[-_\w]+)/plans/(?P<plan_slug>[-_\w]+)/tasks/$',
        TaskListView.as_view(),
        name='list'),
    url(r'^dreams/(?P<dream_slug>[-_\w]+)/plans/(?P<plan_slug>[-_\w]+)/tasks/new/$',
        TaskCreateView.as_view(),
        name='new'),
    url(r'^dreams/(?P<dream_slug>[-_\w]+)/plans/(?P<plan_slug>[-_\w]+)/tasks/(?P<pk>\d+)/edit/$',
